...
class UserMapper extends ClassMapperBase<User> {
  ...
  static EmailAddress _$email(User v) => v.email;
  static const Field<User, EmailAddress> _f$email = Field('email', _$email);
  static Set<Permission> _$permissions(User v) => v.permissions;
  static const Field<User, Set<Permission>> _f$permissions =
      Field('permissions', _$permissions, mode: FieldMode.member);
...
abstract class UserCopyWith<$R, $In extends User, $Out>
  ...
  $R call({String? id, EmailAddress? email});
...
class _UserCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, User, $Out>
  ...
  @override
  $R call({String? id, EmailAddress? email}) => $apply(FieldCopyWithData(
